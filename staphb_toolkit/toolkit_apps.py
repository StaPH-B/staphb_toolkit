...
def main():
    ...
    if program == 'vibrant':
        ...
        vibrant_configuration = config["parameters"]["vibrant"]
        vibrant = sb_prog.Run(command=command, path=path_map, image=vibrant_configuration["image"], tag=vibrant_configuration["tag"])
        vibrant.run()
