...
write.table(snp_mat,"pairwise_snp_distance_matrix.tsv",
            row.names = T,
            col.names = T,
            sep = "\t",
            quote = F)
...
The figures shown here were generated using sequence data processed with our data analysis pipeline, [Monroe](https://github.com/StaPH-B/staphb_toolkit/tree/dev). Sequences were assembled using a reference guided approach (reference genome: Wuhan-1; NCBI RefSeq NC_045512.2). The Pairwise-SNP matrix was generated from were called using (link to X). The phylogenetic tree was generated from a whole genome alignment (link to mafft). The tree was generated using a maximum-likelihood method with the GTR+G4 substitution model and bootstrapped with 1000 replicates (link to iqtree). Report generated using R and designed by Abigail Shockey. If you have questions about this report please contact X at X.
